        ...
        <div className="relative">
          ...
          {showAlertsDropdown && (
            <div className={`absolute right-0 mt-2 w-80 sm:w-96 rounded-2xl border p-3 shadow-2xl z-50 ${
              ...
              <div className="flex items-center justify-between pb-2 border-b border-slate-200 dark:border-slate-700/50 mb-2">
                  ...
                  <div 
                    ...
                    className={`p-2.5 rounded-xl border cursor-pointer transition-colors ${
                      alert.severity === 'CRITICAL'
                        ? darkMode ? 'bg-rose-500/10 border-rose-500/30 hover:bg-rose-500/15' : 'bg-rose-50 border-rose-200 hover:bg-rose-100/80'
                        : darkMode ? 'bg-slate-800/40 border-slate-700/50 hover:bg-slate-800/80' : 'bg-slate-50 border-slate-200 hover:bg-slate-100'
                    }`}
                  >
                    <div className="flex items-center justify-between text-xs font-semibold">
                      <span className={alert.severity === 'CRITICAL' ? (darkMode ? 'text-rose-500' : 'text-rose-600') : (darkMode ? 'text-amber-500' : 'text-amber-600')}>
                        {alert.title}
                      </span>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 font-mono">{alert.timestamp}</span>
                    </div>
